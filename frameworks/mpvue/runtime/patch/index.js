  ...
  function simpleThrottle (fn, delay) {
    ...
    return function (handle, data) {
      ...
      setTimeout(() => {
        ...
        data = accData
        accData = {}
        fn.apply(this, [handle, data])
      }, delay)
    }
  }

  var throttleSetData2 = simpleThrottle(function (handle, data) {
    handle(data)
  }, 50)
...
// 优化每次 setData 都传递大量新数据
  function updateDataToMP () {
    ...
    diffData(this, data)
    throttleSetData2(page.setData.bind(page), data)
  }
